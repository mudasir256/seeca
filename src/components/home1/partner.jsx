export const logos = [
  {
    ...
    logo: '/home_preview/assets/img/OurPartners/5561.MomentumFitness.png',
    writeup:
  ...
  {
    name: 'Hunbul Tex Pvt Ltd',
    logo: '/home_preview/assets/img/OurPartners/5566.HunbulTexPvtLtd.png',
    writeup:
      'Textile-sector client for industrial layouts, office amenity zones, and pragmatic building envelopes tailored to operations.',
  },
  {
    name: 'Maxim Agri Pvt Ltd',
    logo: '/home_preview/assets/img/OurPartners/5584.MaximAgriPvtLtd.png',
    writeup:
      'Agriculture-focused programmes where site planning, structures, and circulation support processing and logistics.',
  },
  {
    name: 'Acamar',
    logo: '/home_preview/assets/img/OurPartners/5611.AcamarLogo.png',
    writeup:
      'Lifestyle and residential-facing partner emphasising refined material palettes, daylight, and calm, ordered spaces.',
  },
  {
    name: 'Hamza Arcade',
    logo: '/home_preview/assets/img/OurPartners/5618.HamzaArcade.png',
    writeup:
      'Retail arcade development showcasing integrated façades, wayfinding, and tenant-ready shell coordination.',
  },
  {
    name: 'CNL UK',
    logo: '/home_preview/assets/img/OurPartners/5636.CNLUK.png',
    writeup:
      'UK-linked collaboration bringing international benchmarks to detailing, specifications, and client reporting.',
  },
  {
    name: 'Pakistan Army',
    logo: '/home_preview/assets/img/OurPartners/5639.PakistanArmy.png',
    writeup:
      'Institutional work delivered with rigorous compliance, security-aware planning, and clear construction sequencing.',
  },
  {
    name: 'Punjab Food Authority',
    logo: '/home_preview/assets/img/OurPartners/5646.Punjab_Food_Authority_logo.png',
    writeup:
      'Public-sector facilities supporting regulatory operations, staff workflow, and transparent public-facing areas.',
  },
  {
    name: 'Momin Solutions',
    logo: '/home_preview/assets/img/OurPartners/5662.Momin-Solutions.png',
    writeup:
      'Systems and integration partner helping align MEP, controls, and smart-building intent with architectural intent.',
  },
  {
    name: 'Masaud Tech',
    logo: '/home_preview/assets/img/OurPartners/5682.MasaudTech.png',
    writeup:
      'Technology partner supporting digital coordination, documentation exchange, and responsive design iterations.',
  },
  {
    name: 'USA Pearl',
    logo: '/home_preview/assets/img/OurPartners/5687.USAperalLOGO-E.png',
    writeup:
  ...
  {
    name: 'Access',
    logo: '/home_preview/assets/img/OurPartners/5696.Accesslogo-1.png',
    writeup:
  ...
  },
  {
    ...
    logo: '/home_preview/assets/img/OurPartners/5720.bahria-university-logo.png',
    writeup:
  ...
  {
    name: "Shumaila's",
    logo: '/home_preview/assets/img/OurPartners/5767.ShumailasLogo.png',
    writeup:
  ...
  {
    name: 'Arafat',
    logo: '/home_preview/assets/img/OurPartners/5920.LogoArafat.png',
    writeup:
  ...
  {
    name: 'HPI',
    logo: '/home_preview/assets/img/OurPartners/5958.hpi-logo-dark.png',
    writeup:
      'Professional and medical infrastructure aligned with equipment plans, infection-control routes, and privacy.',
  },
  {
    name: 'Datum Labs',
    logo: '/home_preview/assets/img/OurPartners/5991.Datumlabs-logo.png',
    writeup:
      'Innovation partner backing data-informed massing studies, performance feedback, and iterative design sprints.',
  },
  {
    name: 'GA Family Restaurant',
    logo: '/home_preview/assets/img/OurPartners/GA_Family_Restaurant_logo_upscaled_4096.png',
    writeup:
      'Family dining destinations with warm materials, flexible seating groups, and acoustic comfort for conversation.',
  },
  {
    name: 'TechScale',
    logo: '/home_preview/assets/img/OurPartners/TechScale.png',
    writeup:
      'Scaling technology workplaces and labs with agile neighbourhoods, focus rooms, and robust cable pathways.',
  },
];
