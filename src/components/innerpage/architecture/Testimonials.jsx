  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{__html: `
        .tc-architecture-testimonials {
          position: relative;
          padding: 120px 0;
          background: #fff;
          overflow: hidden;
        }
        .tc-architecture-testimonials .lg-icon.color-orange1 {
          color: #73bf44 !important;
        }
        .tc-architecture-testimonials .clients-card .text {
          color: #1a1a1a;
        }
        .tc-architecture-testimonials .swiper-button-prev,
        .tc-architecture-testimonials .swiper-button-next {
          color: #73bf44;
        }
        .tc-architecture-testimonials .swiper-button-prev:hover,
        .tc-architecture-testimonials .swiper-button-next:hover {
          color: #73bf44;
        }
        .tc-architecture-testimonials .swiper-pagination-bullet-active {
          background: #73bf44;
        }
      ...
      `}} />
      <section className="tc-testimonials-style1 tc-architecture-testimonials">
                ...
                <div className="clients-slider1">
                  <div className="swiper-wrapper">
                    ...
                    <div className="swiper-slide">
                      <div className="clients-card">
                        <div className="text fsz-45 fw-600 lh-2 js-splittext-lines">
                          "Outstanding architectural design that perfectly captured our vision. The attention to detail and innovative solutions exceeded our expectations."
                        </div>
                        <div className="author">
                          <div className="au-img">
                            <img
                    ...
                    <div className="swiper-slide">
                      <div className="clients-card">
                        <div className="text fsz-45 fw-600 lh-2 js-splittext-lines">
                          "Professional service from start to finish. The team's expertise in sustainable architecture helped us create an eco-friendly building that's both beautiful and functional."
                        </div>
                        <div className="author">
                          <div className="au-img">
                            <img
